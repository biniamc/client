...
export default {
  ...
  // components: {
  //     CustomerServiceAppBar: () => import('./components/core/AppBar'),
  //     CustomerServiceDrawer: () => import('./components/core/Drawer'),
  //     CustomerServiceSettings: () => import('./components/core/Settings'),
  //     CustomerServiceView: () => import('./components/core/View'),
  //   },
